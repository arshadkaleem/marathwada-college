  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "bg-gradient-to-r from-white/95 via-white/90 to-white/95 backdrop-blur-xl shadow-md border-b border-[var(--secondary)]/10 py-2"
          : "bg-white/90  backdrop-blur-2xl border-transparent py-2"
      )}
    >
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          >
            <div className="relative">
              <div className="h-10 w-10 md:h-12 md:w-12 rounded-xl bg-gradient-to-br from-[var(--primary)] via-[var(--primary)]/90 to-[var(--primary)]/80 text-white grid place-items-center font-bold text-lg shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:shadow-[var(--primary)]/25">
                MIT
              </div>
